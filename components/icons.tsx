...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 9.5V6.5" />

        {/* Bottom Node & Branch */}
        <circle cx="6" cy="19" r="1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 14.5v3" />

        {/* Right Branch */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.5 12H12" />

        {/* Pen drawing the right node */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.707 5.293a1 1 0 00-1.414 0L12 12.586V16h3.414l7.293-7.293a1 1 0 000-1.414l-2-2zM12 16l-1 1" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 7l-1.5 1.5" />
    </svg>
);
