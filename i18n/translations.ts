...
const zh = {
  ...
  'sidebar.folderViewOptions': '資料夾檢視選項',
  'sidebar.expandAll': '展開全部資料夾',
  'sidebar.collapseAll': '收合全部資料夾',
  ...
  'fileExplorer.exportFolderMarkdown': '匯出資料夾為 Markdown',
  'fileExplorer.exportFolderMarkdownZip': '匯出資料夾為個別檔案（.zip）',
  'fileExplorer.exportFolderPDF': '匯出資料夾為 PDF',
  ...
  'voiceNote.microphoneSource': '選擇麥克風',
  'voiceNote.microphoneSystemDefault': '系統預設',
  'voiceNote.microphoneUnnamed': '麥克風 {{index}}',
  'voiceNote.microphoneSourceHint': '固定使用此裝置錄音，即使系統之後自動切換預設麥克風（例如 iPhone 接續互通斷線）也不受影響。',
  'voiceNote.captureTabAudio': '同時擷取分享分頁的聲音（例如視訊會議對話）',
  'voiceNote.captureTabAudioUnsupported': '此功能僅支援 Chrome / Edge 瀏覽器',
  'voiceNote.captureVideo': '同時錄下分享的畫面影像（會自動擷取畫面重點插入筆記）',
  ...
  'voiceNote.dropzoneHint': '影片檔會自動抽取音軌，檔案大小上限 500 MB',
  'voiceNote.selectFile': '選擇音訊或影片檔案',
  'voiceNote.recordingVideoHint': '同時錄製畫面中',
  'voiceNote.screenshotsCaptured': '已擷取 {{count}} 張畫面重點',
  'voiceNote.screenshotsHeading': '畫面截圖',
  ...
  'voiceNote.normalizingAudio': '正在處理音檔...',
  'voiceNote.uploadingAudio': '正在上傳音檔...',
  'voiceNote.backendWakingUp': '伺服器剛從休眠中喚醒，處理時間會比平常長一些，請稍候...',
  'voiceNote.microphoneReconnecting': '麥克風已中斷，正在切換到其他可用的麥克風...',
  'voiceNote.microphoneRecovered': '已切換到可用的麥克風，錄音持續進行中。',
  'voiceNote.microphoneDisconnected': '麥克風已中斷，錄音已自動停止，正在處理中斷前錄到的內容。',
  'voiceNote.selectedMicrophoneUnavailable': '選定的麥克風目前無法使用，已改用系統預設麥克風錄音。',
  ...
  'voiceNote.generationRetry': 'AI 目前忙碌中（服務暫時過載），{{seconds}} 秒後自動重試整理筆記，逐字稿已保留不需重新錄音...',
  'voiceNote.recordingLengthPrefix': '錄音長度 {{duration}}，',
  'voiceNote.processingElapsed': '已處理 {{duration}}',
  ...
  'voicePill.backendWakingUp': '伺服器喚醒中...',
...
`,
  ...
  'pipeline.fileTooLargeToSplit': '檔案超過 {{maxMb}} MB 的上傳上限，請先壓縮檔案後再試一次。',

  // --- groq transcription service errors ---
  'groq.missingApiKey': '尚未設定 Groq API 金鑰。',
  'groq.fileTooLarge': '錄音超過 {{maxMb}} MB 的上傳上限，請先壓縮音檔後再試一次。',
...
const en: Record<TranslationKey, string> = {
  ...
  'sidebar.folderViewOptions': 'Folder view options',
  ...
  'fileExplorer.exportFolderMarkdown': 'Export folder as Markdown',
  'fileExplorer.exportFolderMarkdownZip': 'Export folder as separate files (.zip)',
  'fileExplorer.exportFolderPDF': 'Export folder as PDF',
  ...
  'voiceNote.microphoneSource': 'Microphone',
  'voiceNote.microphoneSystemDefault': 'System default',
  'voiceNote.microphoneUnnamed': 'Microphone {{index}}',
  'voiceNote.microphoneSourceHint': "Locks recording to this device, so a later system default switch (e.g. an iPhone Continuity mic disconnecting) won't affect it.",
  ...
  'voiceNote.captureVideo': 'Also record the shared screen video (auto-captures key moments into the note)',
  ...
  'voiceNote.dropzoneHint': 'Video files have their audio track extracted automatically — up to 500 MB',
  'voiceNote.selectFile': 'Select an audio or video file',
  'voiceNote.recordingVideoHint': 'Recording video too',
  'voiceNote.screenshotsCaptured': '{{count}} screen captures so far',
  'voiceNote.screenshotsHeading': 'Screen Captures',
  ...
  'voiceNote.normalizingAudio': 'Processing audio...',
  'voiceNote.uploadingAudio': 'Uploading audio...',
  'voiceNote.backendWakingUp': 'The server just woke up from being idle, so this is taking a bit longer than usual — please wait...',
  'voiceNote.microphoneReconnecting': 'The microphone disconnected. Switching to another available microphone...',
  'voiceNote.microphoneRecovered': 'Switched to an available microphone. Recording is continuing.',
  'voiceNote.microphoneDisconnected': 'The microphone disconnected. Recording stopped automatically, and the captured portion is being processed.',
  'voiceNote.selectedMicrophoneUnavailable': "The selected microphone isn't available right now — recording with the system default microphone instead.",
  ...
  'voiceNote.generationRetry': "AI is temporarily overloaded — retrying automatically in {{seconds}}s. Your transcript is already saved, no need to re-record...",
  'voiceNote.recordingLengthPrefix': 'Recording length {{duration}}, ',
  'voiceNote.processingElapsed': 'Processing time {{duration}}',
  ...
  'voicePill.normalizing': 'Processing audio...',
  ...
  'voicePill.backendWakingUp': 'Server waking up...',
...
`,
  ...
  'pipeline.fileTooLargeToSplit': 'File exceeds the {{maxMb}} MB upload limit — please compress it first and try again.',

  // --- groq transcription service errors ---
  'groq.missingApiKey': 'No Groq API key set yet.',
  'groq.fileTooLarge': 'Recording exceeds the {{maxMb}} MB upload limit — please compress the audio first and try again.',
